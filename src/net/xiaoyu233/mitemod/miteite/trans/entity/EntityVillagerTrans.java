...
public abstract class EntityVillagerTrans extends EntityAgeable implements IMerchant, NPC {
   ...
   private static void forfeather(MerchantRecipeList par0MerchantRecipeList, int par1, Random par2Random, float par3) {
      if (par2Random.nextFloat() < par3) {
         par0MerchantRecipeList.add(new MerchantRecipe(new ItemStack(par1, 1), new ItemStack(Item.feather, 8)));
      }
   }
   ...
   private void addDefaultEquipmentAndRecipies(int par1) {
      ...
      case 4:
         ...
         //TODO NEW!!!
         forfeather(var2, Item.emerald.itemID, this.rand, this.adjustProbability(0.99F));
      }
