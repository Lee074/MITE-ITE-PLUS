...
public class Configs {
    ...
    private static final ConfigCategory ROOT = new ConfigCategory("root").
            addEntry(ConfigCategory.of("GamePlayer").
    ...
    public static class GameMechanics{
        ...
        public static class MobSpawning{
            ...
            public static final FieldReference<Integer> WANDERING_WITCH_SPAWN_LIMIT_DAY_OTHER = new FieldReference<>(32);
            public static final FieldReference<Integer> WANDERING_WITCH_SPAWN_LIMIT_DAY_OVERWORLD = new FieldReference<>(32);
