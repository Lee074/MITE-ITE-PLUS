...
public class Items extends Item{
    ...
    public static final ItemBucket VIBRANIUM_BUCKET_EMPTY = (ItemBucket) new ItemBucket(Constant.getNextItemID(), Materials.vibranium, (Material)null);
    public static final ItemBucket VIBRANIUM_BUCKET_LAVA = (ItemBucket) (new ItemBucket(Constant.getNextItemID(), Materials.vibranium, Material.lava)).setContainerItem(VIBRANIUM_BUCKET_EMPTY);
    public static final ItemBucket VIBRANIUM_BUCKET_WATER = (ItemBucket) (new ItemBucket(Constant.getNextItemID(), Materials.vibranium, Material.water)).setContainerItem(VIBRANIUM_BUCKET_EMPTY);
    ...
    public static void registerItems() {
        ...
        register("bucket/empty", VIBRANIUM_BUCKET_EMPTY);
        register("bucket/lava", VIBRANIUM_BUCKET_LAVA);
        register("bucket/water", VIBRANIUM_BUCKET_WATER);
   }
    ...
    public static void registerRecipes(RecipeRegister register) {
        ...
        register.registerShapedRecipe(new ItemStack(UNIVERSAL_ENHANCE_STONE),
                ...
                'B', Item.book,
                'E', Item.enderPearl);
        register.registerShapedRecipe(new ItemStack(VIBRANIUM_BUCKET_EMPTY),
                true,
                "R R",
                "K",
                'R', Items.VIBRANIUM_INGOT,
                'K', Item.bucketAdamantiumEmpty);
    }
}
