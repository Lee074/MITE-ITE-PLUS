...
public class Blocks extends Block{
    ...
    public static final BlockCharcoal blockCharcoal =  new BlockCharcoal(getNextBlockID());
    ...
    public static void registerBlocks(){
        ...
        registerItemBlock(blockCharcoal, "coal_block");
    }
    ...
    public static void registerRecipes(RecipeRegister register) {
        ...
        register.registerShapelessRecipe(new ItemStack(Item.coal, 9,1), true, blockCharcoal);
        register.registerShapelessRecipe(new ItemStack(Blocks.blockCharcoal), true,
                new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1),
                new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1),
                new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1),new ItemStack(Item.coal, 1, 1));
        register.registerShapedRecipe(new ItemStack(Block.whiteStone,9),true,
                "XYX",
                "XYX",
                "XYX",
                'X',Block.obsidian,
                'Y',Item.eyeOfEnder);
        register.registerShapedRecipe(new ItemStack(Block.endPortalFrame,3),true,
                "YYY",
                "XZX",
                "XXX",
                'X',Block.whiteStone,
